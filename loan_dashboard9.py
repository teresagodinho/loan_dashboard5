...
# Background Information content
    ...
    correlation_matrix = data[['loan_amnt', 'term', 'int_rate', 'annual_inc', 'delinq_2yrs', 'home_ownership_OWN', 'open_acc', 'loan_status']].corr()
    fig = px.imshow(correlation_matrix, labels={'color':'Correlation'})
